...
library Pb {
    ...
    function cntTags(
        Buffer memory buf,
        uint256 maxtag
    ) internal pure returns (uint256[] memory cnts) {
    ...
    function uint8s(
        uint256[] memory arr
    ) internal pure returns (uint8[] memory t) {
    ...
    function uint32s(
        uint256[] memory arr
    ) internal pure returns (uint32[] memory t) {
    ...
    function uint64s(
        uint256[] memory arr
    ) internal pure returns (uint64[] memory t) {
    ...
    function bools(
        uint256[] memory arr
    ) internal pure returns (bool[] memory t) {
